...
namespace UnityEngine.UI
{
    ...
    public class MarqueeText : Text
    {
        ...
        [SerializeField]
        private MarqueeDirection m_MarqueeDirection = MarqueeDirection.Right;

        [SerializeField]
        [Range(0, 10)]
        private float m_Movevelocity = 10f;
        ...
        private float mMoveOffsetValue = 0f;
        ...
        private bool CheckVertexOutLimit(UIVertex[] checkVector3Arr)
        {
            ...
            if (m_MarqueeDirection == MarqueeDirection.Left)
                if (checkVector3Arr[3].position.x > mRightLimitValue) return true;//if (checkVector3Arr[1].position.x < mLeftLimitValue) return true;
        ...
        private Vector3 GetVertexNextPos()
        {
            ...
            if (m_MarqueeDirection == MarqueeDirection.Left)
                return new Vector3(-mTextZoneWidth, 0f, 0f);//return new Vector3(mTextZoneWidth, 0f, 0f);
